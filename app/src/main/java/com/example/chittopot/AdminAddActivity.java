    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AdminAddActivity.this, addvideo.class);
        ...
        c2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminAddActivity.this, JokesActivity.class);
                startActivity(intent);
            }
        });
        ...
        c3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminAddActivity.this, AddAyatActivity.class);
        ...
        c4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminAddActivity.this, Image_upload.class);
